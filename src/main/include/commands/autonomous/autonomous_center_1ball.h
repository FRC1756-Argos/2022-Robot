...
class AutonomousCenter1ball
    : public frc2::CommandHelper<frc2::CommandBase, AutonomousCenter1ball>
    , public AutonomousCommand {
 public:
  AutonomousCenter1ball(IntakeSubsystem* pIntake, ShooterSubsystem* pShooter, SwerveDriveSubsystem* pDrive);
