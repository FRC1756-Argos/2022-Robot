...
class AutonomousCenter1ballDelay
    : public frc2::CommandHelper<frc2::CommandBase, AutonomousCenter1ballDelay>
    , public AutonomousCommand {
 public:
  AutonomousCenter1ballDelay(IntakeSubsystem* pIntake, ShooterSubsystem* pShooter, SwerveDriveSubsystem* pDrive);
