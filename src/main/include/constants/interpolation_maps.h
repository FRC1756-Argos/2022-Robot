...
namespace shooterRange {
  ...
  [[maybe_unused]] constexpr std::array shooterSpeed{
      ...
      InterpMapPoint{21.5_in, 2350.0_rpm},  // Tested 2022-02-27 reverse short shot
      InterpMapPoint{60.0_in, 2650.0_rpm},
      InterpMapPoint{120.0_in, 2975.0_rpm},  // Tested 2022-02-27, 50% accuracy
  ...
  [[maybe_unused]] constexpr std::array hoodAngle{
      ...
      InterpMapPoint{21.5_in, 15.0_deg},  // Tested 2022-02-27 reverse short shot
      InterpMapPoint{60.0_in, 25.0_deg},
      InterpMapPoint{120.0_in, 30.0_deg},  // Tested 2022-02.27, 50% accuracy
